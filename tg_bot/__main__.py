...
Hi {}, my name {}! I [He is](tg://user?id={}) This is a cool admin boat to look at.

Made by python3 in python-telegram-bot and using the library. I'm totally open source. My code is for you [here](https://youtu.be/wKL90i3cjPw) Can be seen.
