...
Can be found on telegram as [𝚍𝚒𝚔 • • •](https://t.me/dodikridwan).
...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/dodikridwan/Haico-Rose-s-Bot)<br>
...
class Development(Config):
    OWNER_ID = 900345244  # my telegram ID
    OWNER_USERNAME = "rootQuarterly"  # my telegram username
